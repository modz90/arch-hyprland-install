...
MICRO_THEME="${HOME}/.config/micro/colorschemes/theme.micro"
...
cat > "$MICRO_THEME" <<EOF
# ${CHOICE}
color-link default             "#${TEXT},#${BG}"
color-link comment             "#${INACTIVE},#${BG}"
color-link identifier          "#${C3},#${BG}"
color-link constant            "#${C6},#${BG}"
color-link statement           "#${C4},#${BG}"
color-link symbol              "#${C6},#${BG}"
color-link preproc             "#${C5},#${BG}"
color-link type                "#${C1},#${BG}"
color-link special             "#${C2},#${BG}"
color-link string              "#${C2},#${BG}"
color-link error               "#${CRITICAL},#${BG}"
color-link todo                "#${WARNING},#${BG}"

color-link statusline          "#${BG},#${ACCENT}"
color-link statusline-error    "#${BG},#${CRITICAL}"
color-link tabbar              "#${BG},#${BG}"
color-link tab-active          "#${TEXT},#${BG}"

color-link line-number         "#${INACTIVE},#${BG}"
color-link current-line-number "#${TEXT},#${BG}"
color-link cursor-line         "#${TEXT},#${C0}"
color-link color-column        "#${TEXT},#${C0}"
color-link indent-char         "#${INACTIVE},#${BG}"

color-link selection           "#${BG},#${ACCENT}"
color-link match-brace         "#${BG},#${WARNING}"
color-link search-result       "#${BG},#${WARNING}"

color-link diff-added          "#${C2},#${BG}"
color-link diff-modified       "#${WARNING},#${BG}"
color-link diff-deleted        "#${CRITICAL},#${BG}"
color-link gutter-error        "#${CRITICAL},#${BG}"
color-link gutter-warning      "#${WARNING},#${BG}"

color-link autocomplete          "#${TEXT},#${C0}"
color-link autocomplete-selected "#${BG},#${ACCENT}"

color-link trailingws          ",#${CRITICAL}"
color-link tab-error           ",#${CRITICAL}"
EOF
